...
func NewRouter() *gin.Engine {
	...
	v1 := r.Group("api/v1")
	{
		...
		v1.POST("/delete-my-friend/:id",api.DeleteFriend)   //删除好友
		...
		authed.Use(middleware.JWT())
		{
			...
			authed.GET("ShowFriendInfo/:id",api.ShowMyFriendInfo)   //展示我的好友的信息
